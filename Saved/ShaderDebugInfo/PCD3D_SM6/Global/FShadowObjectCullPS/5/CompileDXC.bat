...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality -disable-lifetime-markers /T ps_6_6 /E ShadowObjectCullPS /Fc DistanceFieldShadowing.d3dasm /Fo DistanceFieldShadowing.dxil DistanceFieldShadowing.usf
:END
PAUSE
