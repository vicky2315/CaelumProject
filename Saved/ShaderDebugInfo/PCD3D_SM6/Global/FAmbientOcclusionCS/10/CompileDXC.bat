...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality -disable-lifetime-markers /T cs_6_6 /E MainCS /Fc PostProcessAmbientOcclusion.d3dasm /Fo PostProcessAmbientOcclusion.dxil PostProcessAmbientOcclusion.usf
:END
PAUSE
